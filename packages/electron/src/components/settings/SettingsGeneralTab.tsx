          ...
          >
            <div className="flex items-center justify-between">
              <div className="text-left">
                ...
                <div className="text-sm text-[var(--color-text-muted)]">{t.settings.language.english}</div>
              </div>
              {settings.language === 'en' && (
          ...
          >
            <div className="flex items-center justify-between">
              <div className="text-left">
                ...
                <div className="text-sm text-[var(--color-text-muted)]">{t.settings.language.chinese}</div>
              </div>
              {settings.language === 'zh' && (
                <span className="text-[var(--color-accent)]">✓</span>
              )}
